...
public class UserMealsMainTest extends Assert{
    ...
    @Test
    public void testGetDailyCaloriesMapCorrect(){
        Map<LocalDate, Integer> actual = UserMealsMain.getDailyCaloriesMap(mealList);
        assertEquals(expectedTotalCaloriesMap, actual);
    }

    @Test
    public void testGetDailyCaloriesMapIncorrectTotalCalories(){
        Map<LocalDate, Integer> actual = UserMealsMain.getDailyCaloriesMap(mealList);
        expectedTotalCaloriesMap.put(LocalDate.of(2015, Month.MAY, 31), 2110);
        assertNotEquals(expectedTotalCaloriesMap, actual);
    }

    @Test
    public void testGetListWithExceededCorrect(){
        List<UserMealWithExceed> actual = UserMealsMain.getListWithExceeded(expectedTotalCaloriesMap, mealList, LocalTime.of(7, 0), LocalTime.of(12,0), 2000);
    ...
    @Test
    public void testGetListWithExceededInorrectDifferentLists(){
        List<UserMealWithExceed> actual = UserMealsMain.getListWithExceeded(expectedTotalCaloriesMap, mealList, LocalTime.of(7, 0), LocalTime.of(12,0), 2000);
        List<UserMealWithExceed> expected = new ArrayList<>();
        UserMealWithExceed newMeal = new UserMealWithExceed(mealList.get(0), false);
        expected.add(newMeal);
