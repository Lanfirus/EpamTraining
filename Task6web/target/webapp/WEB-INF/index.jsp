...
<head>
    <meta charset="utf-8">
    <title>Andrei Dudchenko's Registration Form</title>
    <style>
    *:focus {outline: none;}
...
<form class="contact_form" action="register" method="post" name="contact_form">
    ...
    <ul>
        ...
        <li>
            ...
            <input type="text" name="comment" placeholder="Any comment" required pattern=".+"/>
        ...
        <li>
            ...
            <input type="text" name="homephonenumber" placeholder="380441234567" required pattern="^(?:380\d{9}|\d{10,12})$"/>
