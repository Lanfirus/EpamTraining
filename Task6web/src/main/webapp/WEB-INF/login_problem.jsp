...
<li>
        ...
        <li>
            ...
            <input type="text" name="comment" placeholder="Any comment" required value=<%= request.getAttribute("commentUser")%>
                    pattern=".+"/>
        ...
        <li>
            ...
            <input type="text" name="homephonenumber" placeholder="380441234567" required
