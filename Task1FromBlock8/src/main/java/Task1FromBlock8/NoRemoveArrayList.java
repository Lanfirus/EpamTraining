...
public class NoRemoveArrayList extends ArrayList{
    ...
    private void incrementValueOfCell(Integer cellIndex, NoRemoveArrayList list){
    ...
    public NoRemoveArrayList() {
        super();
    }

    public NoRemoveArrayList(Integer initialCapacity) {
