...
/**
 * Counts all elements of initial array by single run and introduces NoRemove data structure NoRemoveArrayList.
 *
 */
public class App {
    ...
    public static void main( String[] args ){
        ...
        NoRemoveArrayList countingList = new NoRemoveArrayList(10);
